...
function UserCard({ customerId, clients }) {
  ...
  const subscriptions = card.channelSubscriptions || []; const externalProfiles = card.externalProfiles || []; const invited = profile.referrals?.invited || card.referrals?.invited || [];
  async function send() {
