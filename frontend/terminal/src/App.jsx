...
function BrandMark() { const [failed,setFailed]=useState(false); return <div className="brand-mark">{!failed?<img src={BRAND_OWNER_IMAGE} alt="У Тимоши" onError={()=>setFailed(true)}/>:<span>Т</span>}</div>; }
