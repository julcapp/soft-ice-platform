...
const { PostgresInventoryReservationService } = require('./PostgresInventoryReservationService');
...
module.exports = {
  ...
  InventoryRuntime, InventoryService, InventoryEventSubscriber, InMemoryInventoryRepository, PostgresInventoryReservationService, ...models,
};
