...
function createTelegramRouter({ authCoreService, customerRuntime, clubAccountRuntime, featureFlags = {} }) {
    ...
    asyncHandler(async (req, res) => {
      ...
      sendData(res, req, {
        ...
        attributes: {
          ...
          feature_flags: {
            payments_enabled: Boolean(featureFlags.paymentsEnabled),
            machine_dispatch_enabled: Boolean(featureFlags.machineDispatchEnabled),
          },
        },
      });
    }),
